...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('second_assets', function (Blueprint $table) {
            ...
            $table->string('model');
            $table->enum('status', ['ready', 'pending', 'undeployable', 'archived', 'operational', 'non-operational', 'repairing'])->default('ready');
            ...
            $table->decimal('minimum_renting_days', 5, 2)->nullable();
