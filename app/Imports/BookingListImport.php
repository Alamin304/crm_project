...
class BookingListImport implements ToModel, WithHeadingRow, WithValidation, SkipsOnFailure
{
    use SkipsFailures;
    ...
    {
        return [
            '*.booking_number' => ['required', 'string', 'max:255', 'unique:booking_lists,booking_number'],
