@extends('layouts.app')
@section('title')
    {{ __('messages.bills_of_materials.edit') }}
@endsection
@section('page_css')
            ...
            <div class="card">
                <div class="card-body">
                    <div class="modal-content">
                        {{ Form::model($billsOfMaterial, ['id' => 'editFormBom', 'route' => ['bills-of-materials.update', $billsOfMaterial->id], 'method' => 'put']) }}
                        <div class="modal-body">
                            <div class="alert alert-danger d-none" id="validationErrorsBox"></div>
                            <div class="row">
                                <div class="form-group col-sm-6">
                                    {{ Form::label('BOM_code', __('messages.bills_of_materials.BOM_code') . ':') }}
                                    {{ Form::text('BOM_code', null, ['class' => 'form-control', 'readonly']) }}
                                </div>
                                <div class="form-group col-sm-6">
                                ...
                                <div class="form-group col-sm-6">
                                    ...
                                    <div class="mt-2">
                                        <div class="form-check form-check-inline">
                                            {{ Form::radio('bom_type', 'manufacture', $billsOfMaterial->bom_type == 'manufacture', ['class' => 'form-check-input', 'id' => 'manufacture']) }}
                                            {{ Form::label('manufacture', 'Manufacture this product', ['class' => 'form-check-label']) }}
                                        </div>
                                        <div class="form-check form-check-inline">
                                            {{ Form::radio('bom_type', 'kit', $billsOfMaterial->bom_type == 'kit', ['class' => 'form-check-input', 'id' => 'kit']) }}
