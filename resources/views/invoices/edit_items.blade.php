            ...
            <div class="row">
                <div class="col-md-3 pr-0">
                    <select name="discount_type" id="discount_type" class="form-control p-0 text-center"
                        ...
                        <option value="1" {{ $invoice->discount_type == 1 ? 'selected' : '' }}>$
                        </option>
                        <option value="0" {{ $invoice->discount_type == 0 ? 'selected' : '' }}>%
                        </option>
                    </select>
                </div>
                <div class="col pl-1">
                    <div class="input-group" style="width: 100%;">
                        <select name="percentage_discount" id="percentage_discount" style="display: {{ $invoice->discount_type == 1 ? 'none' : '' }};width:30%;"
                        ...
                        <input type="number" name="final_discount" id="totalDiscount" value="{{ $invoice->discount ?? 0 }}"
