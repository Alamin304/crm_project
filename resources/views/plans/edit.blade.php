            ...
            <div class="card">
                <div class="card-body">
                    <div class="modal-content">
                        {{ Form::open(['id' => 'editPlanForm', 'files' => true]) }}
                        {{ Form::hidden('_method', 'PUT') }}
                        {{ Form::hidden('id', $plan->id, ['id' => 'planId']) }}
...
@section('scripts')
    <script>
        let planUpdateUrl = "{{ route('plans.update', ['plan' => ':id']) }}";
        ...
        $(document).on('submit', '#editPlanForm', function(event) {
            ...
            processingBtn('#editPlanForm', '#btnSave', 'loading');

            let id = $('#planId').val();
            let url = planUpdateUrl.replace(':id', id);
            ...
            $.ajax({
                ...
                complete: function() {
                    processingBtn('#editPlanForm', '#btnSave');
                },
            });
        });
