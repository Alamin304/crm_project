@php
    ...
    // // Debugging or output
    // dd([
    //     'Worked Hours (including Overtime)' => $workedAndOvertimeHours,
    //     'Total Days in Month' => $totalDaysInMonth,
    //     'Worked Days' => $workedDays,
    //     'LOP Days' => $lopDays,
    //     'Daily Working Hours' => $dailyWorkingHours,
    //     'Total Monthly Working Hours' => $totalWorkingHoursInMonth,
    // ]);
    ...
    <div class="contents">
        ...
        <div class="content_body">
            ...
            <table class="salary_info">
                ...
                <tr>
                    <td colspan="2">HRA</td>
                    <td class="earnings-column text-right"> {{ number_format($salarySheet->total_allowances ?? 0, 2) }}
                    </td>
                    <td class="deductions-column"></td>
                </tr>
                ...
                <tr>
                    ...
                    <td class="earnings-column"></td>
                    <td class="deductions-column text-right">{{ number_format($salarySheet->total_deduction ?? 0, 2) }}
                    </td>
                </tr>
                <tr class="total-row">
                    <td colspan="2" class="text-right">Total</td>
                    <td class="earnings-column text-right">
                        {{ number_format($salarySheet->gross_salary - $salarySheet->total_overtimes, 2) }}</td>
                    <td class="deductions-column text-right">
