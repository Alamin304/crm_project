...
@section('content')
    <section class="section">
        <div class="section-header">
            <h1>{{ __('messages.accessory.edit') }}</h1>
        ...
        <div class="section-body">
            <div class="card">
                <div class="card-body">
                    {{ Form::model($accessory, ['id' => 'editForm', 'route' => ['accessories.update', $accessory->id], 'method' => 'put', 'files' => true]) }}
                    <div class="row">
                        ...
                        <div class="form-group col-sm-6" id="sellingPriceField" style="{{ $accessory->for_sell ? '' : 'display: none;' }}">
