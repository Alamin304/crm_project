...
@section('content')
    <section class="section">
        <div class="section-header">
            <h1>{{ __('messages.companies.edit') }}</h1>
...
@section('scripts')
    ...
    <script>
        ...
        $(document).on('submit', '#editForm', function(event) {
            ...
            let id = $('#companies_id').val();

            let htmlContent = $('#editCompanieDescription').summernote('code');
            ...
            $('#editCompanieDescription').val(textContent);
        ...
        $(document).ready(function() {
            $('#editCompanieDescription').summernote({
                height: 150,
                toolbar: [
