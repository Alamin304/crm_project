...
<section class="section">
    <div class="section-header">
        <h1>{{ __('messages.check_in.edit') }}</h1>
    ...
    <div class="section-body">
        {{ Form::model($checkIn, ['route' => ['check_ins.update', $checkIn->id], 'method' => 'put', 'id' => 'editCheckInForm']) }}
        <div class="row">
            <div class="col-md-12">
...
<script>
    $(document).ready(function () {
        ...
        $('#editCheckInForm').on('submit', function (e) {
            e.preventDefault();
            processingBtn('#editCheckInForm', '#btnUpdate', 'loading');
            ...
            $.ajax({
                ...
                complete: function () {
                    processingBtn('#editCheckInForm', '#btnUpdate');
                }
            });
        });
    });
