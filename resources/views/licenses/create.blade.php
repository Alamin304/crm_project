...
@section('content')
    <section class="section">
        <div class="section-header item-align-right">
            <h1>{{ __('messages.licenses.add') }}</h1>
                    ...
                    <div class="row">
                        ...
                        <div class="form-group col-sm-6">
                            <div class="custom-control custom-checkbox mt-4">
                                {{ Form::checkbox('reassignable', 1, false, ['class' => 'custom-control-input', 'id' => 'reassignable']) }}
                                {{ Form::label('reassignable', __('messages.licenses.reassignable'), ['class' => 'custom-control-label']) }}
                            </div>
                        </div>
                        <div class="form-group col-sm-6">
                            <div class="custom-control custom-checkbox mt-4">
                                {{ Form::checkbox('maintained', 1, false, ['class' => 'custom-control-input', 'id' => 'maintained']) }}
