                    ...
                    let row =
                        ...
                        <td class="pl-1"><div  style="width:100px  !important;color:black;">${employee.designation.name??""}</div></td>
                         <td class="p-1">
                            ...
                            <input type="text" name="actual_hours[${employee.id}]" id="ac_hours_${employee.id}" class="form-control actual_hours" style="width:100px !important; color:black; text-align:center;" readonly>
                        </td>
                        <td class="p-1">
