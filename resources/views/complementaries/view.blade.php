...
@section('content')
    <section class="section">
        <div class="section-header item-align-right">
            <h1>{{ __('messages.complementaries.view') }}</h1>
                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        <div class="form-group col-sm-12 col-md-6">
                            ...
                            <p>{{ $complementary->room_type }}</p>
                        </div>
                        <div class="form-group col-sm-12 col-md-6">
                            {{ Form::label('rate', __('messages.complementaries.rate')) }}
                            <p>{{ number_format($complementary->rate, 2) }}</p>
                        </div>
                        <div class="form-group col-sm-12 mb-0">
                            {{ Form::label('complementary', __('messages.complementaries.complementary')) }}
