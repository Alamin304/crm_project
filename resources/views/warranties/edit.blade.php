                            ...
                            <div class="form-row-line mb-4">
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <div class="input-group date" id="warrantyDatePicker" data-target-input="nearest">
                                        ...
                                        <div class="input-group-append" data-target="#warrantyDatePicker" data-toggle="datetimepicker">
                            ...
                            <div class="form-row-line mb-4">
                                <div class="form-group col-md-3">
                                    ...
                                    {{ Form::select('customer', [
                                        ...
                                        '3' => 'Acme Corporation',
                                        '4' => 'XYZ Enterprises'
                                    ], $warranty->customer, ['class' => 'form-control select2', 'required', 'id' => 'customer', 'placeholder' => 'Select Customer']) }}
                                </div>
                                ...
                                <div class="form-group col-md-3">
                                    ...
                                    {{ Form::select('invoice', [
                                        ...
                                        'INV-003' => 'INV-003',
                                        'INV-004' => 'INV-004'
                                    ], $warranty->invoice, ['class' => 'form-control select2', 'id' => 'invoice', 'placeholder' => 'Select Invoice']) }}
                                </div>

                                <div class="form-group col-md-3">
                                    {{ Form::label('product_service_name', 'Product/Service:') }}<span class="required">*</span>
                                    {{ Form::select('product_service_name', [
                                        'Laptop Repair' => 'Laptop Repair',
                                        'Phone Screen Replacement' => 'Phone Screen Replacement',
                                        'Software License' => 'Software License',
                                        'Annual Maintenance' => 'Annual Maintenance'
                                    ], $warranty->product_service_name, ['class' => 'form-control select2', 'required', 'id' => 'productService', 'placeholder' => 'Select Product/Service']) }}
                                </div>

                                <div class="form-group col-md-3">
                                    {{ Form::label('warranty_receipt_process', 'Receipt Process:') }}
                                    {{ Form::select('warranty_receipt_process', [
                                        'email' => 'Email',
                                        'printed' => 'Printed',
                                        'digital' => 'Digital Wallet',
                                        'none' => 'None'
                                    ], $warranty->warranty_receipt_process, ['class' => 'form-control select2', 'id' => 'receiptProcess', 'placeholder' => 'Select Process']) }}
                                </div>
                            </div>
        ...
        $(document).on('submit', '#editWarrantyForm', function(event) {
            ...
            fieldsToValidate.forEach(fieldId => {
                ...
                if ($(`#${fieldId}`).summernote('isEmpty')) {
                    ...
                    displayErrorMessage(`${fieldId.replace(/([A-Z])/g, ' $1').replace(/^./, str => str.toUpperCase())} must not contain only white space.`);
                    isValid = false;
                    return false;
                }
            });
