...
@section('content')
    <section class="section">
        <div class="section-header item-align-right">
            <h1>{{ __('messages.campaigns.edit') }}</h1>
            ...
            <div class="card">
                <div class="card-body">
                    <div class="modal-content">
                        {{ Form::open(['id' => 'editCampaignForm', 'files' => true]) }}
                        {{ Form::hidden('_method', 'PUT') }}
                        {{ Form::hidden('id', $campaign->id, ['id' => 'campaignId']) }}

                        <div class="modal-body">
                            <div class="alert alert-danger d-none" id="validationErrorsBox"></div>
                            <div class="row">
                                <div class="form-group col-sm-6">
                                    {{ Form::label('campaign_code', __('messages.campaigns.campaign_code') . ':') }}<span
                                        class="required">*</span>
                                    {{ Form::text('campaign_code', $campaign->campaign_code, [
                                        'class' => 'form-control',
                                        'required',
                                        'id' => 'campaignCode',
                                ...
                                <div class="form-group col-sm-6">
                                    {{ Form::label('campaign_name', __('messages.campaigns.campaign_name') . ':') }}<span
                                        class="required">*</span>
                                    {{ Form::text('campaign_name', $campaign->campaign_name, [
                                        'class' => 'form-control',
                                        'required',
                                        'id' => 'campaignName',
                                ...
                                <div class="form-group col-sm-6">
                                    {{ Form::label('recruitment_plan', __('messages.campaigns.recruitment_plan') . ':') }}<span
                                        class="required">*</span>
                                    {{ Form::text('recruitment_plan', $campaign->recruitment_plan, [
                                        'class' => 'form-control',
                                        'required',
                                        'id' => 'recruitmentPlan',
                                ...
                                <div class="form-group col-sm-6">
                                    {{ Form::label('recruitment_channel_from', __('messages.campaigns.recruitment_channel_from') . ':') }}<span
                                        class="required">*</span>
                                    {{ Form::select(
                                ...
                                <div class="form-group col-sm-6">
                                    {{ Form::label('position', __('messages.campaigns.position') . ':') }}<span
                                        class="required">*</span>
                                    {{ Form::select(
                                        'position',
                                        [
                                ...
                                <div class="form-group col-sm-6">
                                    {{ Form::label('company', __('messages.campaigns.company') . ':') }}<span
                                        class="required">*</span>
                                    {{ Form::text('company', $campaign->company, [
                                        'class' => 'form-control',
                                        'required',
                                        'id' => 'company',
                                ...
                                <div class="form-group col-sm-6">
                                    {{ Form::label('recruited_quantity', __('messages.campaigns.recruited_quantity') . ':') }}<span
                                        class="required">*</span>
                                    {{ Form::number('recruited_quantity', $campaign->recruited_quantity, [
                                        'class' => 'form-control',
                                        'required',
                                        'min' => 1,
                                ...
                                <div class="form-group col-sm-6">
                                    {{ Form::label('working_form', __('messages.campaigns.working_form') . ':') }}<span
                                        class="required">*</span>
                                    {{ Form::select(
                                        'working_form',
                                        [
                                ...
                                <div class="form-group col-sm-6">
                                    {{ Form::label('department', __('messages.campaigns.department') . ':') }}<span
                                        class="required">*</span>
                                    {{ Form::select(
                                        'department',
                                        [
                                ...
                                <div class="form-group col-sm-6">
                                    {{ Form::label('workplace', __('messages.campaigns.workplace') . ':') }}<span
                                        class="required">*</span>
                                    {{ Form::text('workplace', $campaign->workplace, [
                                        'class' => 'form-control',
                                        'required',
                                        'id' => 'workplace',
                                ...
                                <div class="form-group col-sm-6">
                                    {{ Form::label('starting_salary_from', __('messages.campaigns.starting_salary_from') . ':') }}<span
                                        class="required">*</span>
                                    {{ Form::number('starting_salary_from', $campaign->starting_salary_from, [
                                        'class' => 'form-control',
                                        'required',
                                        'min' => 0,
                                        'step' => '0.01',
                                ...
                                <div class="form-group col-sm-6">
                                    {{ Form::label('starting_salary_to', __('messages.campaigns.starting_salary_to') . ':') }}<span
                                        class="required">*</span>
                                    {{ Form::number('starting_salary_to', $campaign->starting_salary_to, [
                                        'class' => 'form-control',
                                        'required',
                                        'min' => 0,
                                        'step' => '0.01',
                                ...
                                <div class="form-group col-sm-6">
                                    {{ Form::label('from_date', __('messages.campaigns.from_date') . ':') }}<span
                                        class="required">*</span>
                                    {{ Form::date('from_date', $campaign->from_date, [
                                        'class' => 'form-control',
                                        'required',
                                        'id' => 'fromDate',
                                    ]) }}
                                ...
                                <div class="form-group col-sm-6">
                                    {{ Form::label('to_date', __('messages.campaigns.to_date') . ':') }}<span
                                        class="required">*</span>
                                    {{ Form::date('to_date', $campaign->to_date, [
                                        'class' => 'form-control',
                                        'required',
                                        'id' => 'toDate',
                                    ]) }}
                                ...
                                <div class="form-group col-sm-12">
                                    {{ Form::label('reason', __('messages.campaigns.reason') . ':') }}<span
                                        class="required">*</span>
                                    {{ Form::textarea('reason', $campaign->reason, [
                                        'class' => 'form-control',
                                        'required',
                                        'id' => 'reason',
                                        'rows' => 3,
                                ...
                                <div class="form-group col-sm-12 mb-0">
                                    {{ Form::label('job_description', __('messages.campaigns.job_description') . ':') }}<span
                                        class="required">*</span>
                                    {{ Form::textarea('job_description', $campaign->job_description, [
                                ...
                                <div class="form-group col-sm-12">
                                    ...
                                    {{ Form::select(
                                        ...
                                        is_array($campaign->managers) ? $campaign->managers : json_decode($campaign->managers ?? '[]', true),
                                        [
                                            'class' => 'form-control select2',
                                            'id' => 'managers',
                                            'multiple' => 'multiple',
                                ...
                                <div class="form-group col-sm-12">
                                    ...
                                    {{ Form::select(
                                        ...
                                        is_array($campaign->followers) ? $campaign->followers : json_decode($campaign->followers ?? '[]', true),
                                        [
                                            'class' => 'form-control select2',
                                            'id' => 'followers',
                                            'multiple' => 'multiple',
                                ...
                                <div class="form-group col-sm-6">
                                    ...
                                    {{ Form::text('meta_title', $campaign->meta_title, [
                                        'class' => 'form-control',
                                        'id' => 'metaTitle',
                                ...
                                <div class="form-group col-sm-6">
                                    ...
                                    {{ Form::textarea('meta_description', $campaign->meta_description, [
                                        'class' => 'form-control',
                                        'id' => 'metaDescription',
                                        'rows' => 2,
                                ...
                                <div class="form-group col-sm-6">
                                    ...
                                    {{ Form::number('age_from', $campaign->age_from, [
                                        'class' => 'form-control',
                                        'min' => 18,
                                        'id' => 'ageFrom',
                                ...
                                <div class="form-group col-sm-6">
                                    ...
                                    {{ Form::number('age_to', $campaign->age_to, [
                                        'class' => 'form-control',
                                        'min' => 18,
                                        'id' => 'ageTo',
                                ...
                                <div class="form-group col-sm-6">
                                    ...
                                    {{ Form::number('height', $campaign->height, [
                                        'class' => 'form-control',
                                        'min' => 0,
                                        'step' => '0.01',
                                        'id' => 'height',
                                ...
                                <div class="form-group col-sm-6">
                                    ...
                                    {{ Form::number('weight', $campaign->weight, [
                                        'class' => 'form-control',
                                        'min' => 0,
                                        'step' => '0.01',
                                        'id' => 'weight',
                                ...
                                <div class="form-group col-sm-6">
                                    {{ Form::label('literacy', __('messages.campaigns.literacy') . ':') }}<span
                                        class="required">*</span>
                                    {{ Form::text('literacy', $campaign->literacy, [
                                        'class' => 'form-control',
                                        'required',
                                        'id' => 'literacy',
                                ...
                                <div class="form-group col-sm-6">
                                    {{ Form::label('seniority', __('messages.campaigns.seniority') . ':') }}<span
                                        class="required">*</span>
                                    {{ Form::text('seniority', $campaign->seniority, [
                                        'class' => 'form-control',
                                        'required',
                                        'id' => 'seniority',
                                ...
                                <div class="form-group col-sm-6">
                                    ...
                                    @if ($campaign->attachment)
                                        <div class="mt-2">
                                            <a href="{{ asset('storage/' . $campaign->attachment) }}" target="_blank">
                                                {{ __('messages.campaigns.view_attachment') }}
                                            </a>
                                        </div>
                                    @endif
                                ...
                                <div class="form-group col-sm-6">
                                    <div class="custom-control custom-checkbox">
                                        {{ Form::checkbox('is_active', 1, $campaign->is_active, ['class' => 'custom-control-input', 'id' => 'isActive']) }}
...
@section('scripts')
    <script>
        let campaignUpdateUrl = "{{ route('campaigns.update', ['campaign' => ':id']) }}";
        ...
        $(document).on('submit', '#editCampaignForm', function(event) {
            event.preventDefault();
            processingBtn('#editCampaignForm', '#btnSave', 'loading');

            let id = $('#campaignId').val();
            let url = campaignUpdateUrl.replace(':id', id);
            ...
            $.ajax({
                ...
                complete: function() {
                    processingBtn('#editCampaignForm', '#btnSave');
                },
            });
        });
