    ...
    <main>
        <div class="content_info">
            <table cellspacing="0" style="width: 100%; border-collapse: collapse;font-size:11px;line-height:9px;">
                <tr>
                    <td style="width: 2.3cm;">Qoute No <br>رقم عرض السعر</td>
                    <td style="width: 1.22cm;">{{ $estimate->estimate_number }}</td>
                    <td style="width: 2cm;">Qoute Date<br>تاريخ عرض السعر</td>
                    <td style="width: 2cm;">{{ \Carbon\Carbon::parse($estimate->estimate_date)->format('d-m-Y') }}</td>
                    <td style="width: 2.6cm;">Qoute Validity<br>صلاحية عرض السعر</td>
                                            ...
                                            <td style="width: 70%; border-right: 1px solid {{ $bColor }};">
                                                <table style="width: 100%; border-collapse: collapse;">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td
                                                            style="width: 70%; padding: 4px; border-bottom: 1px solid {{ $bColor }};">
                                                            {{ $estimate->branch?->bank?->account_number ?? '' }}</td>
                                                    </tr>
                                                    <tr>
                                                        <!-- Row 2 -->
                                                        <td
