                        ...
                        <div class="modal-body">
                            ...
                            <div class="image-upload-wrapper">
                                @if($propertyOwner->profile_image)
                                    <img id="profileImagePreview" src="{{ asset('storage/'.$propertyOwner->profile_image) }}" class="profile-image-preview" alt="Profile Image">
                                    <div class="current-image-text">Current Image</div>
                                @else
                                    <img id="profileImagePreview" src="{{ asset('assets/img/default-user.png') }}" class="profile-image-preview" alt="Default Image">
                                @endif
