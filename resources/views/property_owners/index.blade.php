...
@section('title')
    {{ __('messages.property_owners.property_owners') }}
@endsection
...
@section('content')
    ...
    <section class="section">
        <div class="section-header item-align-right">
            <h1>{{ __('messages.property_owners.property_owners') }}</h1>
            ...
            <div class="float-right d-flex">
                <div class="dropdown export-dropdown mr-2">
                    <button class="btn btn-primary dropdown-toggle form-btn" type="button" id="exportDropdown"
                        ...
                        {{ __('messages.property_owners.export') }}
                    </button>
                    <div class="dropdown-menu dropdown-menu-right" aria-labelledby="exportDropdown">
                        <a class="dropdown-item" href="{{ route('property_owners.export', ['format' => 'pdf']) }}">
                            {{ __('messages.common.pdf') }}
                        </a>
                        <a class="dropdown-item" href="{{ route('property_owners.export', ['format' => 'csv']) }}">
                            {{ __('messages.common.csv') }}
                        </a>
                        <a class="dropdown-item" href="{{ route('property_owners.export', ['format' => 'xlsx']) }}">
                            {{ __('messages.common.excel') }}
                        </a>
                        <a class="dropdown-item" href="{{ route('property_owners.export', ['format' => 'print']) }}"
                            target="_blank">
                ...
                <div class="float-right">
                    <a href="{{ route('property_owners.create') }}" class="btn btn-primary form-btn">
        ...
        <div class="modal fade" id="propertyOwnerImportModal" tabindex="-1" role="dialog"
            ...
            <div class="modal-dialog" role="document">
                {{-- <form action="{{ route('property_owners.import') }}" method="POST" enctype="multipart/form-data"
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <a href="{{ route('property_owners.sample-csv') }}" class="btn btn-info btn-sm mb-3">
...
@section('scripts')
    <script>
        ...
        let propertyOwnerCreateUrl = "{{ route('property_owners.store') }}";
            ...
            $.ajax({
                ...
                success: function(result) {
                    if (result.success) {
                        ...
                        $('#addModal').modal('hide');
                        $('#propertyOwnerTable').DataTable().ajax.reload(null, false);
                    }
                },
        ...
        let propertyOwnerTable = $('#propertyOwnerTable').DataTable({
            oLanguage: {
            ...
            serverSide: true,
            ajax: {
                url: "{{ route('property_owners.index') }}",
            },
            lengthMenu: [
                [10, 25, 50, 100, -1],
                [10, 25, 50, 100, "All"]
        ...
        $(document).on('click', '.delete-btn', function(event) {
            ...
            deleteItem("{{ route('property_owners.destroy', ['propertyOwner' => ':id']) }}".replace(':id', id),
                '#propertyOwnerTable', "{{ __('messages.property_owner.property_owner') }}");
        });
        ...
        function renderActionButtons(id) {
            let deleteUrl = "{{ route('property_owners.destroy', ':id') }}".replace(':id', id);
            let viewUrl = "{{ route('property_owners.view', ':id') }}".replace(':id', id);
            let editUrl = "{{ route('property_owners.edit', ':id') }}".replace(':id', id);
